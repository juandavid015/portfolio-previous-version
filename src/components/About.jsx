...
import WarmImage from '../assets/images/ProfileWarm-removebg-preview.png'
        ...
        bg-white dark:bg-dark" id='about'>
            <div className="sm:p-82px p-32px">
                ...
                <p className="mb-2">
                    ...
                    <span className="dark:text-secondary-light-1 text-secondary-dark-2 font-bold">
            ...
            lg:self-start self-center lg:justify-self-center mb-64px">
                ...
                <img className="h-full w-full object-contain max-w-[250px] m-auto" src={WarmImage} alt="profile"  />
            </div>
        </div>
    )
}